...
def meow(n: int): # type hint for developers to know what the variable type would be 
    for _ in range(n):
        print("meow")
...
#mypy should show an error: meows4.py:8: error: Argument 1 to "meow" has incompatible type "str"; expected "int"  [arg-type]
